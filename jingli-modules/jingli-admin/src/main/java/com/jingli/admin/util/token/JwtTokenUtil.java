...
package com.jingli.admin.util.token;
...
public class JwtTokenUtil {
    ...
    public static void parseToken(String token) throws JwtException {
        Jwts.parser().setSigningKey(Constant.SECRET).parseClaimsJws(token).getBody();
    }
    ...
    private static String doGenerateToken(Map<String, Object> claims, String subject) {
        ...
        final Date expirationDate = new Date(createdDate.getTime() + Constant.EXPIRATION * 1000);
